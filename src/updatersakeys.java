...
public class updatersakeys implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			MyAWS.rsaKey=RSA.loadKey(pub_key, priv_key);
